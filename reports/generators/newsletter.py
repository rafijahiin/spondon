...
def _draw_footer(canvas):
    ...
    canvas.drawRightString(W - MARGIN, 10, 'AI-assisted content — reviewed before distribution')
...
def build_newsletter(
    ...
    doc._header_info = {'period_label': period_label, 'organisation': organisation}
    ...
    story.append(Paragraph(
        '<i>This bulletin was generated by the Spondon Integrated Data Management System. '
        'AI-assisted content has been reviewed by programme staff before distribution. '
        'For queries, contact CIPRB RCH Department.</i>',
        S['caption'],
    ))
