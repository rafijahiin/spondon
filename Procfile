...
web: python manage.py migrate --noinput && python manage.py seed_users && python manage.py seed_centers && gunicorn spondon.wsgi --bind 0.0.0.0:$PORT --workers 2 --timeout 120
